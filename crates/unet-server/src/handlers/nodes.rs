...
use crate::api::{
    ApiResponse, CreateNodeRequest, UpdateNodeRequest, NodeResponse, PaginatedResponse
};
...
pub async fn get_node_status(
    ...
    snmp_data.insert("1.3.6.1.2.1.1.5.0".to_string(), 
                    SnmpValue::String("router-01.example.com".to_string()));
    snmp_data.insert("1.3.6.1.2.1.1.6.0".to_string(), 
    ...
    snmp_data.insert("1.3.6.1.2.1.2.2.1.5.1".to_string(), SnmpValue::Gauge32(1000000000)); // 1 Gbps
    ...
    // Traffic statistics
    snmp_data.insert("1.3.6.1.2.1.2.2.1.10.1".to_string(), SnmpValue::Counter32(1234567890)); // input octets
    snmp_data.insert("1.3.6.1.2.1.2.2.1.11.1".to_string(), SnmpValue::Counter32(987654321)); // input packets
    snmp_data.insert("1.3.6.1.2.1.2.2.1.16.1".to_string(), SnmpValue::Counter32(2345678901)); // output octets
    snmp_data.insert("1.3.6.1.2.1.2.2.1.17.1".to_string(), SnmpValue::Counter32(1876543210)); // output packets
