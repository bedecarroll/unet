...
use unet_core::template::{
    AutoGeneratedPattern, ConsistencyCheckResult, ContextBuilder, RenderOptions,
    TemplateConfigConsistencyChecker, TemplateDrivenSlicer, TemplateEngine, TemplateRenderer,
    TemplateSliceValidationResult,
};
use uuid::Uuid;
